...
<head>
	...
	<link rel="stylesheet" href="/example/static/qiniu/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="/example/static/qiniu/css/main.css">
...
<div class="container">
	<div class="text-left col-md-12 wrapper">
        ...
        <input type="hidden" id="domain" value="http://lab.homeway.me/qiniu.php">
        <input type="hidden" id="uptoken_url" value="/api/qiniu/token">
...
<script src="/example/static/js/sha1.js"></script>
<script src="/example/static/crypto-js/core.js"></script>
...
<script type="text/javascript" src="/example/static/qiniu/js/qiniu.js"></script>
<script type="text/javascript" src="/example/static/qiniu/js/main.js"></script>
</body>
</html>
