...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    //$.post("/api/callback", res.data, function(e){
    //    e = JSON.parse(e);
    //    console.log(e);
    //});
    ...
    var showImg = $('<img src="/example/static/qiniu/img/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '/example/static/qiniu/img/default.png');
        ...
        $(img).on('load', function() {
            ...
            function initImg(url, key, height) {
                ...
                modalBody.find('img').attr('src', '/public/qiniu/img/loading.gif');
